...
FRIDAY operates as an autonomous **Supervisor** over the cloud-hosted Stratex 24/7 Algorithmic Trading Platform on Binance Futures Testnet (`http://localhost:8000`). 
