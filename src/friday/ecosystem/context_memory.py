...
class ContextualConversationMemory:
    ...
    def get_latest_mention(self, entity_type: str | None = None) -> ContextEntity | None:
    ...
    def resolve_pronoun_reference(self, query: str) -> dict[str, Any] | None:
    ...
    def resolve_temporal_follow_up(self, query: str) -> dict[str, Any] | None:
